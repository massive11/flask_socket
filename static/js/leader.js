...
function get_message() {
    let mine_classes = Actions.get_message();
    console.log(mine_classes);
    new Vue({
        el: '#mine_class-table',
        data: {
    ...
    let str = "<tr><td>" + mine_classes.name +
                                "</td><td>"+ mine_classes.score + "</td></tr>";
    $("#mine_class-table tbody").html(str);
